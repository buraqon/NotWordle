...

{
    ...
    [SerializeField] private RawImage FB_useerDp;

    [SerializeField] private GameObject friendstxtprefab;

    [SerializeField] private GameObject GetFriendsPos;
...

    {
        ...
        GameManager.Instance.ResetUserInfo();
    }
    ...
    public void DisplayID(IResult result)
    {
        ...
        GameManager.Instance.SetUserInfo("ID", id);
    }
